...
%prep
%setup -q -n libSavitar-4.11.0
cd %{_builddir}/libSavitar-4.11.0
...
cp %{_builddir}/libSavitar-4.11.0/cmake/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/libSavitar/ff3ed70db4739b3c6747c7f624fe2bad70802987
pushd clr-build
%make_install
popd
