...
Source0  : https://github.com/Ultimaker/libSavitar/archive/4.6.1/libSavitar-4.6.1.tar.gz
...
%prep
%setup -q -n libSavitar-4.6.1
cd %{_builddir}/libSavitar-4.6.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588267625
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libSavitar-4.6.1/LICENSE %{buildroot}/usr/share/package-licenses/libSavitar/f98c7fffc3fe221e79fa19fe89c74e74c0da1266
cp %{_builddir}/libSavitar-4.6.1/cmake/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/libSavitar/ff3ed70db4739b3c6747c7f624fe2bad70802987
pushd clr-build
%make_install
popd
