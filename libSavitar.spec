...
Source0  : https://github.com/Ultimaker/libSavitar/archive/4.12.0/libSavitar-4.12.0.tar.gz
...
%prep
%setup -q -n libSavitar-4.12.0
cd %{_builddir}/libSavitar-4.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636573960
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libSavitar-4.12.0/LICENSE %{buildroot}/usr/share/package-licenses/libSavitar/f98c7fffc3fe221e79fa19fe89c74e74c0da1266
cp %{_builddir}/libSavitar-4.12.0/cmake/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/libSavitar/ff3ed70db4739b3c6747c7f624fe2bad70802987
pushd clr-build
%make_install
popd
