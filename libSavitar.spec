...
Version  : 4.2.0
Release  : 6
URL      : https://github.com/Ultimaker/libSavitar/archive/4.2.0/libSavitar-4.2.0.tar.gz
Source0  : https://github.com/Ultimaker/libSavitar/archive/4.2.0/libSavitar-4.2.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1565053596
mkdir -p clr-build
pushd clr-build
